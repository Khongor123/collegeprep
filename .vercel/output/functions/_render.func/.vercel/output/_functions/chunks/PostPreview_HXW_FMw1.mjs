import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent, F as Fragment } from './astro/server_BadD3_hS.mjs';
import 'kleur/colors';
import 'clsx';
...
(Updated on ${renderComponent($$result2, "FormattedDate", $$FormattedDate, { "date": updatedDate })})
        ...
        Read Guide <ArrowRight class="fill-current w-4 h-4" />
    </div> --> </a>`;
