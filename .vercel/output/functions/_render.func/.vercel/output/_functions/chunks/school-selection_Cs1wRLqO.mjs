const id = "school-selection.md";
						const collection = "guide";
						const slug = "school-selection";
						...
						const data = {title:"School Selection",excerpt:"How to decide which schools you should send your application to, and what things should you be researching?",publishDate:new Date(1707667200000),isFeatured:true,tags:["College"],seo:{image:{src:"post-14.jpg",alt:"cover"},pageType:"website"}};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Khongor/Desktop/CP-Astro/src/content/guide/school-selection.md",
							rawData: undefined,
						};
