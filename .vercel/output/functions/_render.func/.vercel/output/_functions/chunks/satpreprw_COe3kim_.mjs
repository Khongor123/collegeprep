const id = "satpreprw.md";
						const collection = "guide";
						const slug = "satpreprw";
						...
						const data = {title:"Preparing for the SAT - Reading and Writing",publishDate:new Date(1707667200000),isFeatured:true,tags:["College","Exam","SAT"],seo:{image:{src:"post-2.jpg",alt:"cover"},pageType:"website"}};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/Khongor/Desktop/CP-Astro/src/content/guide/satpreprw.md",
							rawData: undefined,
						};
